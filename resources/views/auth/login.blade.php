                ...
                <div class="card-body">
                  @if (session('status'))
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        -->
                        <div class="form-group row">
                            <label for="login" class="col-sm-4 col-form-label text-md-right">{{ __('UserId or Email') }}</label>

                            <div class="col-md-6">
                                <input id="login" type="text" class="form-control{{ $errors->has('user_id') || $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('user_id') ?: old('email') }}" required="" autofocus="">
